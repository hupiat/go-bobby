...
struct L19 : LevelProtocol {
    ...
    init() {
        strikesNumber = Repository().getStrikesNumber(label: "l19")
        ...
        blocks = [Block(X: 1, Y: 2), Block(X: 1, Y: 8), Block(X: 1, Y: 7), Block(X: 1, Y: 17),
                  ...
                  Block(X: 7, Y: 10), Block(X: 10, Y: 9), Block(X: 7, Y: 9), Block(X: 4, Y: 13),
                  Block(X: 12, Y: 14), Block(X: 1, Y: 13), Block(X: 7, Y: 18), Block(X: 9, Y: 14),
